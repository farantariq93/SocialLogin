# Social Media Integration with the help of hybrid auth library
Now it is really easy to integrate social media networks like facecbook, twitter, instagram and youtube with the help of hybrid auth library. An easy way to create account with the help of login with social media networks.
